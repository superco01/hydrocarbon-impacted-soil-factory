                    ...
                    $(go.Panel, "Auto",
                       // myDiagram.model.nodeDataArray[0].statusNode = "Parent",
                        ...
                        $(go.Panel, "Table",
                            ...
                            $(go.TextBlock, "Subject       :", textStyle2(),  // the name
                                {
                                    row: 1, column: 0,
                            ...
                            $(go.TextBlock, "Start Time   : ", textStyle2(),  // the name
                                {
                                    row: 2, column: 0,
                                    editable: false, isMultiline: false,
                                    minSize: new go.Size(10, 16)
                            ...
                            $(go.TextBlock, "Due Time    :", textStyle2(),  // the name
                                {
                                    row: 3, column: 0,
                                    editable: false, isMultiline: false,
                                    minSize: new go.Size(10, 16)
                            ...
                            $(go.TextBlock, "Cycle Time  :", textStyle2(),  // the name
                                {
                                    row: 4, column: 0,
                                    editable: false, isMultiline: false,
                                    minSize: new go.Size(10, 16)
                ...
                $(go.Node, "Table", nodeStyle(),
                    ...
                    $(go.Panel, "Auto",
                      ...
                      //  $(go.model.nodeDataArray[0].statusNode = "Parent"),
                            ...
                            $(go.TextBlock, "PIC : ", textStyle2(),  // the name
                                {
                                    row: 2, column: 0,
                                    editable: false, isMultiline: false,
                                    minSize: new go.Size(10, 16)
