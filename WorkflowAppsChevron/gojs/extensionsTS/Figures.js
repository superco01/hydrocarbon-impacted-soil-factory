(function (factory) {
    ...
    */
    var FigureParameter = (function () {
        ...
        */
        FigureParameter.prototype.setFigureParameter = function (figurename, index, figparam) {
    ...
    */
    ...
    go.Shape.defineFigureGenerator("RoundedIBeam", function (shape, w, h) {
        ...
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1))
            param1 = .5; // default value of Parameter1
    ...
    go.Shape.defineFigureGenerator("HourGlass", function (shape, w, h) {
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1) || param1 < 0)
            param1 = 30; // default value for param1
    ...
    go.Shape.defineFigureGenerator("Arrow", function (shape, w, h) {
        ...
        var temp = getIntersection(0, .5 + param2 / 2, 1, .5 + param2 / 2, 1 - param1, 1, 1, .5, tempPoint());
    ...
    go.Shape.defineFigureGenerator("Arrow2", function (shape, w, h) {
        ...
        // Arrow width
        if (isNaN(param2))
            param2 = 30; // 30 is the default value
    ...
    go.Shape.defineFigureGenerator("DoubleEndArrow", function (shape, w, h) {
        ...
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1))
            param1 = .7; // default value for param1
    ...
    go.Shape.defineFigureGenerator("DoubleEndArrow2", function (shape, w, h) {
        ...
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1))
            param1 = 70; // default value for param1
        var param2 = shape ? shape.parameter2 : NaN;
        if (isNaN(param2))
            param2 = 90; // default value for param2
        var fig = new go.PathFigure(w, .5 * h, true);
        geo.add(fig);
    ...
    go.Shape.defineFigureGenerator("IBeamArrow", function (shape, w, h) {
        ...
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1))
            param1 = .7; // default value is 0 for parameter
        var fig = new go.PathFigure(w, .5 * h, true);
        geo.add(fig);
        fig.add(new go.PathSegment(go.PathSegment.Line, .7 * w, h));
    ...
    go.Shape.defineFigureGenerator("IBeamArrow2", function (shape, w, h) {
        ...
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1))
            param1 = 40; // default value is 0 for parameter
        var fig = new go.PathFigure(w, .5 * h, true);
        geo.add(fig);
    ...
    go.Shape.defineFigureGenerator("Pointer", function (shape, w, h) {
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1))
            param1 = .1; // BackPoint Default Value
        // var param1 shape ? shape.parameter1 : NaN;
    ...
    go.Shape.defineFigureGenerator("RoundedPointer", function (shape, w, h) {
        ...
        geo.add(fig);
        fig.add(new go.PathSegment(go.PathSegment.Line, 0, h));
        fig.add(new go.PathSegment(go.PathSegment.Bezier, 0, 0, .5 * w, .75 * h, .5 * w, .25 * h).close());
    ...
    go.Shape.defineFigureGenerator("SplitEndArrow", function (shape, w, h) {
        ...
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1))
            param1 = .7; // default value if user has not set one
        fig.add(new go.PathSegment(go.PathSegment.Line, .7 * w, h));
    ...
    go.Shape.defineFigureGenerator("SplitEndArrow2", function (shape, w, h) {
        ...
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1))
            param1 = 50; // default value if user has not set one
        if (param1 >= h) {
            // in attempts to leave the shape with the same proportions
            var newParamValue = h / param1; // this will be the proportion we try to recreate
            // h - newParamValue =
    ...
    go.Shape.defineFigureGenerator("Cylinder1", function (shape, w, h) {
        ...
        fig.add(new go.PathSegment(go.PathSegment.Bezier, 1.0 * w, .1 * h, (.5 + cpxOffset) * w, 0, 1.0 * w, (.1 - cpyOffset) * h));
        fig.add(new go.PathSegment(go.PathSegment.Line, w, .9 * h));
        // Bottom curve
        fig.add(new go.PathSegment(go.PathSegment.Bezier, .5 * w, 1.0 * h, 1.0 * w, (.9 + cpyOffset) * h, (.5 + cpxOffset) * w, 1.0 * h));
        fig.add(new go.PathSegment(go.PathSegment.Bezier, 0, .9 * h, (.5 - cpxOffset) * w, 1.0 * h, 0, (.9 + cpyOffset) * h));
        fig.add(new go.PathSegment(go.PathSegment.Line, 0, .1 * h));
        var fig2 = new go.PathFigure(0, .1 * h, false);
        geo.add(fig2);
        fig2.add(new go.PathSegment(go.PathSegment.Bezier, .5 * w, .2 * h, 0, (.1 + cpyOffset) * h, (.5 - cpxOffset) * w, .2 * h));
        fig2.add(new go.PathSegment(go.PathSegment.Bezier, 1.0 * w, .1 * h, (.5 + cpxOffset) * w, .2 * h, 1.0 * w, (.1 + cpyOffset) * h));
    ...
    go.Shape.defineFigureGenerator("Cylinder2", function (shape, w, h) {
        ...
        geo.add(fig2);
        // The base (bottom)
        fig2.add(new go.PathSegment(go.PathSegment.Bezier, .5 * w, .8 * h, 0, (.9 - cpyOffset) * h, (.5 - cpxOffset) * w, .8 * h));
        fig2.add(new go.PathSegment(go.PathSegment.Bezier, w, .9 * h, (.5 + cpxOffset) * w, .8 * h, w, (.9 - cpyOffset) * h));
    ...
    go.Shape.defineFigureGenerator("Cylinder3", function (shape, w, h) {
        ...
        fig.add(new go.PathSegment(go.PathSegment.Line, .9 * w, 0));
        fig.add(new go.PathSegment(go.PathSegment.Bezier, w, .5 * h, (.9 + cpxOffset) * w, 0, w, (.5 - cpyOffset) * h));
        fig.add(new go.PathSegment(go.PathSegment.Bezier, .9 * w, h, w, (.5 + cpyOffset) * h, (.9 + cpxOffset) * w, h));
        fig.add(new go.PathSegment(go.PathSegment.Line, .1 * w, h));
        fig.add(new go.PathSegment(go.PathSegment.Bezier, 0, .5 * h, (.1 - cpxOffset) * w, h, 0, (.5 + cpyOffset) * h));
        fig.add(new go.PathSegment(go.PathSegment.Bezier, .1 * w, 0, 0, (.5 - cpyOffset) * h, (.1 - cpxOffset) * w, 0));
        var fig2 = new go.PathFigure(.1 * w, 0, false);
        geo.add(fig2);
        // Cylinder line (left)
        fig2.add(new go.PathSegment(go.PathSegment.Bezier, .2 * w, .5 * h, (.1 + cpxOffset) * w, 0, .2 * w, (.5 - cpyOffset) * h));
        fig2.add(new go.PathSegment(go.PathSegment.Bezier, .1 * w, h, .2 * w, (.5 + cpyOffset) * h, (.1 + cpxOffset) * w, h));
    ...
    go.Shape.defineFigureGenerator("Cylinder4", function (shape, w, h) {
        ...
        geo.add(fig2);
        // Cylinder line (right)
        fig2.add(new go.PathSegment(go.PathSegment.Bezier, .8 * w, .5 * h, (.9 - cpxOffset) * w, 0, .8 * w, (.5 - cpyOffset) * h));
        fig2.add(new go.PathSegment(go.PathSegment.Bezier, .9 * w, h, .8 * w, (.5 + cpyOffset) * h, (.9 - cpxOffset) * w, h));
    ...
    go.Shape.defineFigureGenerator("Card", function (shape, w, h) {
        ...
        var param1 = shape ? shape.parameter1 : NaN;
        if (isNaN(param1))
            param1 = .2; // Distance between left and inner rect
